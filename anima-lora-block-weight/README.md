...
- [Part A · Beginner](#part-a--beginner-start-here) — plain language, copy-paste recipes.
- [Part B · Technical](#part-b--technical-internals-parameters-implementation) — how it works, full parameters, implementation.
...
This node uses `blocks[_.](\d+)`, matching both dot and underscore. Verified against a real
